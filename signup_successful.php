...
<body>
	...
	<div id="fixedbar">
		...
		<span id="signup-response">Signup successful</span>
	...
	<div class="wrapper"><br><br><br><br>
	    ...
	    <form class="form" method="post" onsubmit="return isvalidatedtwo();" action="showride.php">
		    ...
		    <input   style="width: 450px" type="text"  placeholder="SOURCE" name="source" class="z typeahead tt-query" required ><br>  
